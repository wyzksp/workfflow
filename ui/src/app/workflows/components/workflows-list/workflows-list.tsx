            ...
            <Consumer>
                {ctx => (
                    <Page
                        title='工作流'
                        toolbar={{
                            breadcrumbs: [{title: '工作流系统', path: uiUrl('workflows')}],
                            actionMenu: {
                                items: [
                                    {
                                        title: '提交新的工作流',
                ...
                <div className='argo-table-list'>
                    <div className='row argo-table-list__head'>
                        ...
                        <div className='row small-11'>
                            ...
                            <div className='columns small-2'>开始时间</div>
                            <div className='columns small-2'>结束时间</div>
                            <div className='columns small-1'>持续时间</div>
                            <div className='columns small-1'>进展</div>
                            <div className='columns small-1'>细节</div>
                        </div>
                    </div>
